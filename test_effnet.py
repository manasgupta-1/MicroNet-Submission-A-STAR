...
parser.add_argument('--checkpoint-path', default='EffnetB2_pruned_model.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--effnet', action='store_true',
					help='choose EfficientNet B2, igonres architecture')
...
# def main_worker(gpu, ngpus_per_node, args, weight_mask_arr):
	...
	# create model
	if args.effnet:
		print("=> using pre-trained model '{}'".format('EfficientNet B2'))
	...
	if args.effnet:
		image_size = EfficientNet.get_image_size('efficientnet-b2')
